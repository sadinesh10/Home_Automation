...
function Interval_Time({ onBackPress }) {
  ...
  const [intervalAdding, setIntervalAdding] = useState(false);
  const array = [
    {
      id: 1,
      percentage: "80%",
                  ...
                  <View style={{ flexDirection: "row" }}>
                    ...
                    >
                      <View>
                        ...
                        >
                          <Text style={{ marginRight: 5 }}>On Time</Text>
                          <Text style={{ marginRight: 5 }}>Off Time</Text>
                          <Text style={{ marginRight: 5 }}>On Peroid</Text>
                          <Text>Off Peroid</Text>
                        </View>
                        <View>
                          <View style={{ flexDirection: "row" }}>
                            <Text
